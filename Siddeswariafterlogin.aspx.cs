...
{
    public partial class Siddeswariafterlogin : System.Web.UI.Page
    {
        ...
        protected void Eventsdisplay()
        {
            ...
            LblIndPdEndval.Text = Convert.ToString(EventHdrInd.SiddOrgPeriodEnddate);
                //Lblevntdetl.Text = latevnt.SiddOrgEventDetails;
            }
            catch(Exception ex)
            {
                throw (ex);
        ...
        protected void BooksVideodisplay()
        {
            ...
            var Bookshome = (from q in db.Siddeswari_Master_Books
                             where q.SiddOrgDispPage == "Homepage"
                             select new { q.SiddOrgBookname, q.SiddOrgBookimg,q.SiddOrgBookDesc,q.SiddOrgsaleprice,q.SiddOrgbkrating,q.SiddOrgBkstck }).ToList();
        ...
        {
            Response.Redirect("SchedulePujHomam.aspx", false);
        }

        protected void BtnSchd_Click(object sender, EventArgs e)
        {
            Response.Redirect("AfteloginUSAIternary.aspx", false);
        }

        protected void BtnInd_Click(object sender, EventArgs e)
        {
            Response.Redirect("AfterloginIndiaIternary.aspx", false);
        }
        ...
        protected void lnkimg_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ProductBookDetail.aspx?bookimgval=" + bookimgval + "&bookname=" + bookname + "&bookprice=" + bookprice + "&bookdescrp=" + bookdescrimg + "&bookstockqty=" + bookstockqty + "&bookratng=" + bookratng);
        }
        ...
        protected void lnBtnbook_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ProductBookDetail.aspx?bookimgval=" + bookimgval + "&bookname=" + bookname + "&bookprice=" + bookprice + "&bookdescrp=" + bookdescr + "&bookstockqty=" + bookstockqty + "&bookratng=" + bookratng);
        }
    }
}