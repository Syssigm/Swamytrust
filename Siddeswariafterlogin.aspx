<%@ Page Title="" Language="C#" MasterPageFile="~/Siddeswariafterlogin.Master" AutoEventWireup="true" CodeBehind="Siddeswariafterlogin.aspx.cs" Inherits="Siddeswari.Siddeswariafterlogin" %>
...
<asp:Button ID="BtnSchdPuja" class="btn btn-warning mb-2" runat="server" Text="Schedule Pooja/Homa" OnClick="BtnSchdPuja_Click" />
 ...
 <div class="container-fluid welcome-content">
  ...
  <h3>Our Mission</h3>
  <p class="container text-center"><asp:Label ID="Lblmission" runat="server"></asp:Label>
</p>
    <div class="row">
...
<h3>Books by Swamiji - <asp:Button ID="Btnbook" Class="btn btn-sm btn-light" runat="server" Text="Click here for more" OnClick="Btnbook_Click" /> <%--<button class="btn btn-sm btn-light">Click here for more</button>--%> </h3>
...
<small class="text-primary font-size-60">SPONSOR / DONATE TO ANY OF THE PROJECTS LISTED BELOW</small></h3>
 ...
 <asp:Repeater id="Rptdonate" runat="server" OnItemCommand="Rptdonate_ItemCommand">
        <ItemTemplate>
      <div class="col-sm-4 col-xs-12 margin-top-20"><a href="Siddeswaridonate.aspx"> <img src="<%# Eval("SiddOrgDonschemimagepath") %>" class="img-fluid img-thumbnail center-block" />
        <h4 class="my-2"> <a href="Siddeswaridonate.aspx"><%# Eval("SiddOrgDonschemename") %></h4>
