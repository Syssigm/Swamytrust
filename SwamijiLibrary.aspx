<%@ Page Title="" Language="C#" MasterPageFile="~/Siddeswari.Master" AutoEventWireup="true" CodeBehind="SwamijiLibrary.aspx.cs" Inherits="Siddeswari.Library" %>
...
<div class="row text-center">
      <asp:Repeater id="rptbks" OnItemCommand="rptbks_ItemCommand" runat="server">
          <ItemTemplate>
		<div class="col-lg-3">
		  <a href="Login.aspx"><img src="<%#Eval("SiddOrgBookimg") %>" border="0" class="img-fluid img-thumbnail max-height-300" /></a>
          ...
          <asp:LinkButton ID="Lnkbtn" OnClick="Lnkbtn_Click" CommandArgument= '<%#Eval("SiddOrgBookimg")+"&"+ Eval("SiddOrgBookname")+"&"+ Eval("SiddOrgsaleprice")+"&"+ Eval("SiddOrgBkstck")+"&"+Eval("SiddOrgbkrating") %>' class="btn btn-sm btn-warning mb-4" runat="server">Read More</asp:LinkButton></p>
